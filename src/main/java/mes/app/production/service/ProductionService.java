...
public class ProductionService {
    ...
    public Map<String, Object> getlist(String startDate, String endDate, String property,String userid) {
       ...
       /* result.put("recent_property", searchDataList(startDate, endDate, "recent_property"));
        result.put("most_viewed_property", searchDataList(startDate, endDate, "most_viewed_property"));
        result.put("popular_property", searchDataList(startDate, endDate, "popular_property"));*/
    ...
    private List<Map<String, Object>> searchDataList(String startDate, String endDate, String property, String userid) {
        ...
        switch (property) {
            ...
            /*case "recent_property":
                return getrecentData(property, startDate, endDate);
            case "most_viewed_property":
                return getmostData(property, startDate, endDate);
            case "popular_property":
                return getpopularData(property, startDate, endDate);*/
            default:
